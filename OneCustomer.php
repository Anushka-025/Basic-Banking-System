...
session_start();
$server="localhost";
$username="id17440009_anushka";
$password="vn?_muoC3~>)WrqI";
$db="id17440009_bank_system";
...
<!-- Make Transcation -->
                ...
                <?php
                $db = mysqli_connect("localhost", "id17440009_anushka", "vn?_muoC3~>)WrqI", "id17440009_bank_system");
